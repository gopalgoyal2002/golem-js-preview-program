 ...
 *
 * @export
 * @interface ExeScriptCommandResult
 */
export interface ExeScriptCommandResult {
    /**
     *
     * @type {number}
     * @memberof ExeScriptCommandResult
     */
    'index': number;
    /**
     *
...
/**
    ...
    * @enum {string}
    */
export declare enum ExeScriptCommandResultResultEnum {
    Ok = "Ok",
    Error = "Error"
}
