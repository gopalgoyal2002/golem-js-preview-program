...
export declare const ProviderApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    approveAgreement: (agreementId: string, appSessionId?: string, timeout?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    collectDemands: (subscriptionId: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    counterProposalOffer: (subscriptionId: string, proposalId: string, demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getOffers: (options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getProposalDemand: (subscriptionId: string, proposalId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    queryReplyOffers: (subscriptionId: string, queryId: string, body: object, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    subscribeOffer: (demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    unsubscribeOffer: (subscriptionId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ProviderApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    approveAgreement(agreementId: string, appSessionId?: string, timeout?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * This is a blocking operation. It will not return until there is at least one new event. All events are appearing on both sides equally.  Returns Agreement related events: * `AgreementApprovedEvent` - Indicates that the Agreement has been approved   by the Provider.   - The Provider is now ready to accept a request to start an Activity     as described in the negotiated agreement.   - The Providers’s corresponding `approveAgreement` call returns `Approved`     after this event is emitted.  * `AgreementRejectedEvent` - Indicates that the Provider has called   `rejectAgreement`, which effectively stops the Agreement handshake.   The Requestor may attempt to return to the Negotiation phase by sending   a new Proposal.  * `AgreementCancelledEvent` - Indicates that the Requestor has called   `cancelAgreement`, which effectively stops the Agreement handshake.  * `AgreementTerminatedEvent` - Indicates that the Agreement has been   terminated by specified party (contains signature).
     * @summary CollectAgreementEvents - Collects events related to an Agreement.
     * @param {number} [timeout] Timeout used in long-polling calls (in seconds). How many seconds server should wait for response containing new events (&#x60;0.0&#x60; means it should return immediately if there are no events)
     ...
     * @throws {RequiredError}
     */
    collectDemands(subscriptionId: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Event>>>;
    /**
     * Creates and sends a modified version of original Offer (a counter-proposal) adjusted to previously received Proposal (ie. Demand). Changes Proposal state to `Draft`. Returns created Proposal id.
     * @summary CounterProposalOffer - Responds with a bespoke Offer to received Demand.
     * @param {string} subscriptionId
     ...
     * @throws {RequiredError}
     */
    counterProposalOffer(subscriptionId: string, proposalId: string, demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>>;
    /**
     *
     * @summary GetAgreement - Fetches agreement with given agreement id.
     * @param {string} agreementId
     ...
     * @throws {RequiredError}
     */
    getOffers(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Offer>>>;
    /**
     *
     * @summary GetProposalDemand - Fetches Proposal (Demand) with given id.
     * @param {string} subscriptionId
     ...
     * @throws {RequiredError}
     */
    getProposalDemand(subscriptionId: string, proposalId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Proposal>>;
    /**
     * Sends a response to a received property value query.  The Market Matching Mechanism, when resolving the match relation for the specific Demand-Offer pair, is to detect the “dynamic” properties required (via constraints) by the other side. At this point, it is able to query the issuing node for those properties and submit the other side’s requested properties as the context of the query.  **Note**: The property query responses may be submitted in “chunks”, ie. the responder may choose to resolve ‘quick’/lightweight’ properties faster and provide response sooner, while still working on more time-consuming properties in the background. Therefore the response contains both the resolved properties, as well as list of properties which responder knows still require resolution.  **Note**: This method must be implemented for Market API Capability Level 2.
     * @summary QueryReplyOffers - Handles dynamic property query.
     * @param {string} subscriptionId
     ...
     * @throws {RequiredError}
     */
    queryReplyOffers(subscriptionId: string, queryId: string, body: object, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * The Requestor side is notified about the Provider’s decision to reject a negotiated agreement. This effectively stops the Agreement handshake.  **Note**: Mutually exclusive with `approveAgreement`.
     * @summary RejectAgreement - Rejects Agreement proposed by the Requestor.
     * @param {string} agreementId
     ...
     * @throws {RequiredError}
     */
    subscribeOffer(demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>>;
    /**
     * Method to finish/close the Agreement while in `Approved` state.  The other party gets notified about calling party decision to terminate a \"running\" agreement.  **Note**: Can be invoked at any time after Agreement was approved by both sides.  **Note**: Financial and reputational consequences are not defined by this specification.
     * @summary TerminateAgreement - Terminates approved Agreement.
     * @param {string} agreementId
     ...
     * @throws {RequiredError}
     */
    unsubscribeOffer(subscriptionId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
...
export interface ProviderApiInterface {
     ...
     */
    approveAgreement(agreementId: string, appSessionId?: string, timeout?: number, options?: AxiosRequestConfig): AxiosPromise<void>;
    /**
     * This is a blocking operation. It will not return until there is at least one new event. All events are appearing on both sides equally.  Returns Agreement related events: * `AgreementApprovedEvent` - Indicates that the Agreement has been approved   by the Provider.   - The Provider is now ready to accept a request to start an Activity     as described in the negotiated agreement.   - The Providers’s corresponding `approveAgreement` call returns `Approved`     after this event is emitted.  * `AgreementRejectedEvent` - Indicates that the Provider has called   `rejectAgreement`, which effectively stops the Agreement handshake.   The Requestor may attempt to return to the Negotiation phase by sending   a new Proposal.  * `AgreementCancelledEvent` - Indicates that the Requestor has called   `cancelAgreement`, which effectively stops the Agreement handshake.  * `AgreementTerminatedEvent` - Indicates that the Agreement has been   terminated by specified party (contains signature).
     * @summary CollectAgreementEvents - Collects events related to an Agreement.
     * @param {number} [timeout] Timeout used in long-polling calls (in seconds). How many seconds server should wait for response containing new events (&#x60;0.0&#x60; means it should return immediately if there are no events)
     ...
     * @memberof ProviderApiInterface
     */
    collectDemands(subscriptionId: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig): AxiosPromise<Array<Event>>;
    /**
     * Creates and sends a modified version of original Offer (a counter-proposal) adjusted to previously received Proposal (ie. Demand). Changes Proposal state to `Draft`. Returns created Proposal id.
     * @summary CounterProposalOffer - Responds with a bespoke Offer to received Demand.
     * @param {string} subscriptionId
     ...
     * @memberof ProviderApiInterface
     */
    counterProposalOffer(subscriptionId: string, proposalId: string, demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig): AxiosPromise<string>;
    /**
     *
     * @summary GetAgreement - Fetches agreement with given agreement id.
     * @param {string} agreementId
     ...
     * @memberof ProviderApiInterface
     */
    getOffers(options?: AxiosRequestConfig): AxiosPromise<Array<Offer>>;
    /**
     *
     * @summary GetProposalDemand - Fetches Proposal (Demand) with given id.
     * @param {string} subscriptionId
     ...
     * @memberof ProviderApiInterface
     */
    getProposalDemand(subscriptionId: string, proposalId: string, options?: AxiosRequestConfig): AxiosPromise<Proposal>;
    /**
     * Sends a response to a received property value query.  The Market Matching Mechanism, when resolving the match relation for the specific Demand-Offer pair, is to detect the “dynamic” properties required (via constraints) by the other side. At this point, it is able to query the issuing node for those properties and submit the other side’s requested properties as the context of the query.  **Note**: The property query responses may be submitted in “chunks”, ie. the responder may choose to resolve ‘quick’/lightweight’ properties faster and provide response sooner, while still working on more time-consuming properties in the background. Therefore the response contains both the resolved properties, as well as list of properties which responder knows still require resolution.  **Note**: This method must be implemented for Market API Capability Level 2.
     * @summary QueryReplyOffers - Handles dynamic property query.
     * @param {string} subscriptionId
     ...
     * @memberof ProviderApiInterface
     */
    queryReplyOffers(subscriptionId: string, queryId: string, body: object, options?: AxiosRequestConfig): AxiosPromise<void>;
    /**
     * The Requestor side is notified about the Provider’s decision to reject a negotiated agreement. This effectively stops the Agreement handshake.  **Note**: Mutually exclusive with `approveAgreement`.
     * @summary RejectAgreement - Rejects Agreement proposed by the Requestor.
     * @param {string} agreementId
     ...
     * @memberof ProviderApiInterface
     */
    subscribeOffer(demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig): AxiosPromise<string>;
    /**
     * Method to finish/close the Agreement while in `Approved` state.  The other party gets notified about calling party decision to terminate a \"running\" agreement.  **Note**: Can be invoked at any time after Agreement was approved by both sides.  **Note**: Financial and reputational consequences are not defined by this specification.
     * @summary TerminateAgreement - Terminates approved Agreement.
     * @param {string} agreementId
     ...
     * @memberof ProviderApiInterface
     */
    unsubscribeOffer(subscriptionId: string, options?: AxiosRequestConfig): AxiosPromise<void>;
}
/**
...
export declare class ProviderApi extends BaseAPI implements ProviderApiInterface {
     ...
     */
    approveAgreement(agreementId: string, appSessionId?: string, timeout?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * This is a blocking operation. It will not return until there is at least one new event. All events are appearing on both sides equally.  Returns Agreement related events: * `AgreementApprovedEvent` - Indicates that the Agreement has been approved   by the Provider.   - The Provider is now ready to accept a request to start an Activity     as described in the negotiated agreement.   - The Providers’s corresponding `approveAgreement` call returns `Approved`     after this event is emitted.  * `AgreementRejectedEvent` - Indicates that the Provider has called   `rejectAgreement`, which effectively stops the Agreement handshake.   The Requestor may attempt to return to the Negotiation phase by sending   a new Proposal.  * `AgreementCancelledEvent` - Indicates that the Requestor has called   `cancelAgreement`, which effectively stops the Agreement handshake.  * `AgreementTerminatedEvent` - Indicates that the Agreement has been   terminated by specified party (contains signature).
     * @summary CollectAgreementEvents - Collects events related to an Agreement.
     * @param {number} [timeout] Timeout used in long-polling calls (in seconds). How many seconds server should wait for response containing new events (&#x60;0.0&#x60; means it should return immediately if there are no events)
     ...
     * @memberof ProviderApi
     */
    collectDemands(subscriptionId: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Event[]>>;
    /**
     * Creates and sends a modified version of original Offer (a counter-proposal) adjusted to previously received Proposal (ie. Demand). Changes Proposal state to `Draft`. Returns created Proposal id.
     * @summary CounterProposalOffer - Responds with a bespoke Offer to received Demand.
     * @param {string} subscriptionId
     ...
     * @memberof ProviderApi
     */
    counterProposalOffer(subscriptionId: string, proposalId: string, demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<string>>;
    /**
     *
     * @summary GetAgreement - Fetches agreement with given agreement id.
     * @param {string} agreementId
     ...
     * @memberof ProviderApi
     */
    getOffers(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Offer[]>>;
    /**
     *
     * @summary GetProposalDemand - Fetches Proposal (Demand) with given id.
     * @param {string} subscriptionId
     ...
     * @memberof ProviderApi
     */
    getProposalDemand(subscriptionId: string, proposalId: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Proposal>>;
    /**
     * Sends a response to a received property value query.  The Market Matching Mechanism, when resolving the match relation for the specific Demand-Offer pair, is to detect the “dynamic” properties required (via constraints) by the other side. At this point, it is able to query the issuing node for those properties and submit the other side’s requested properties as the context of the query.  **Note**: The property query responses may be submitted in “chunks”, ie. the responder may choose to resolve ‘quick’/lightweight’ properties faster and provide response sooner, while still working on more time-consuming properties in the background. Therefore the response contains both the resolved properties, as well as list of properties which responder knows still require resolution.  **Note**: This method must be implemented for Market API Capability Level 2.
     * @summary QueryReplyOffers - Handles dynamic property query.
     * @param {string} subscriptionId
     ...
     * @memberof ProviderApi
     */
    queryReplyOffers(subscriptionId: string, queryId: string, body: object, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * The Requestor side is notified about the Provider’s decision to reject a negotiated agreement. This effectively stops the Agreement handshake.  **Note**: Mutually exclusive with `approveAgreement`.
     * @summary RejectAgreement - Rejects Agreement proposed by the Requestor.
     * @param {string} agreementId
     ...
     * @memberof ProviderApi
     */
    subscribeOffer(demandOfferBase: DemandOfferBase, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<string>>;
    /**
     * Method to finish/close the Agreement while in `Approved` state.  The other party gets notified about calling party decision to terminate a \"running\" agreement.  **Note**: Can be invoked at any time after Agreement was approved by both sides.  **Note**: Financial and reputational consequences are not defined by this specification.
     * @summary TerminateAgreement - Terminates approved Agreement.
     * @param {string} agreementId
     ...
     * @memberof ProviderApi
     */
    unsubscribeOffer(subscriptionId: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
}
