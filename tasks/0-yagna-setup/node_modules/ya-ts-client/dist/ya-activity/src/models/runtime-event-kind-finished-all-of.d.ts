 ...
 */
import { RuntimeEventKindFinishedBody } from './runtime-event-kind-finished-body';
/**
 *
 * @export
 * @interface RuntimeEventKindFinishedAllOf
 */
export interface RuntimeEventKindFinishedAllOf {
    /**
     *
     * @type {RuntimeEventKindFinishedBody}
     * @memberof RuntimeEventKindFinishedAllOf
     */
