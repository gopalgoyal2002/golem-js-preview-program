...
export declare const ProviderApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    collectActivityEvents: (appSessionId?: string, afterTimestamp?: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getActivityState: (activityId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getActivityUsage: (activityId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    setActivityState: (activityId: string, activityState: ActivityState, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ProviderApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    collectActivityEvents(appSessionId?: string, afterTimestamp?: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProviderEvent>>>;
    /**
     *
     * @summary Get state of specified Activity.
     * @param {string} activityId
     ...
     * @throws {RequiredError}
     */
    getActivityState(activityId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityState>>;
    /**
     *
     * @summary Get usage of specified Activity.
     * @param {string} activityId
     ...
     * @throws {RequiredError}
     */
    getActivityUsage(activityId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ActivityUsage>>;
    /**
     *
     * @summary Set state of specified Activity.
     * @param {string} activityId
     ...
     * @throws {RequiredError}
     */
    setActivityState(activityId: string, activityState: ActivityState, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
...
export interface ProviderApiInterface {
     ...
     */
    collectActivityEvents(appSessionId?: string, afterTimestamp?: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig): AxiosPromise<Array<ProviderEvent>>;
    /**
     *
     * @summary Get state of specified Activity.
     * @param {string} activityId
     ...
     * @memberof ProviderApiInterface
     */
    getActivityState(activityId: string, options?: AxiosRequestConfig): AxiosPromise<ActivityState>;
    /**
     *
     * @summary Get usage of specified Activity.
     * @param {string} activityId
     ...
     * @memberof ProviderApiInterface
     */
    getActivityUsage(activityId: string, options?: AxiosRequestConfig): AxiosPromise<ActivityUsage>;
    /**
     *
     * @summary Set state of specified Activity.
     * @param {string} activityId
     ...
     * @memberof ProviderApiInterface
     */
    setActivityState(activityId: string, activityState: ActivityState, options?: AxiosRequestConfig): AxiosPromise<void>;
}
/**
...
export declare class ProviderApi extends BaseAPI implements ProviderApiInterface {
     ...
     */
    collectActivityEvents(appSessionId?: string, afterTimestamp?: string, timeout?: number, maxEvents?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ProviderEvent[]>>;
    /**
     *
     * @summary Get state of specified Activity.
     * @param {string} activityId
     ...
     * @memberof ProviderApi
     */
    getActivityState(activityId: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ActivityState>>;
    /**
     *
     * @summary Get usage of specified Activity.
     * @param {string} activityId
     ...
     * @memberof ProviderApi
     */
    getActivityUsage(activityId: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ActivityUsage>>;
    /**
     *
     * @summary Set state of specified Activity.
     * @param {string} activityId
     ...
     * @memberof ProviderApi
     */
    setActivityState(activityId: string, activityState: ActivityState, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
}
